...
def main( df, columnTextName, var_list):
		...
		#if var_list[5] == 1 or var_list[15] == 1: #if vader box  or component scores checked:
		...
		if var_list[9] == 1 or var_list[10] == 1 or var_list[11] == 1 or var_list[12] == 1 or var_list[15] == 1:
			print("Loading spaCy")
			# root.update_idletasks()
			import spacy
...
####Beginning of file iteration#######
		file_counter = 1
		nfiles = len(df.index)
		for indice, row in df.iterrows(): #for filename in filenames:
			variable_list = []
			header_list = ["filename","nwords"]

			print("Processing: " + str(indice) + " of " + str(nfiles) + " files")
			...
			pre_text = str(df.at[indice, columnTextName]).lower().split()
			text_2 = []
			...
			#### Normal Program ####
			if var_list[1] == 1 and var_list[13] == 1: run_galc(text)
			if var_list[2] == 1 and var_list[13] == 1: run_nrc(text_2)
			if var_list[3] == 1 and var_list[13] == 1: run_anew(text_2)
			if var_list[4] == 1 and var_list[13] == 1: run_sentic(text_2)
			if var_list[5] == 1 and var_list[13] == 1: run_vader(Text)
			if var_list[6] == 1 and var_list[13] == 1: run_lu_hui(text_2)
			if var_list[7] == 1 and var_list[13] == 1: run_gi(text_2)
			if var_list[8] == 1 and var_list[13] == 1: run_lasswell(text_2)
			
			#### Normal Program Negation Controlled ####
			if var_list[1] == 1 and var_list[13] == 1 and var_list[14] == 1: run_galc(neg_3_text,"_neg_3")
			if var_list[2] == 1 and var_list[13] == 1 and var_list[14] == 1: run_nrc(neg_3_text,"_neg_3")
			if var_list[3] == 1 and var_list[13] == 1 and var_list[14] == 1: run_anew(neg_3_text,"_neg_3")
			if var_list[4]== 1 and var_list[13] == 1 and var_list[14] == 1: run_sentic(neg_3_text,"_neg_3")
			#if var_list[5].get() == 1 and var_list[13].get() == 1: run_vader(Text) #Vader already has negation control
			if var_list[6] == 1 and var_list[13] == 1 and var_list[14] == 1: run_lu_hui(neg_3_text,"_neg_3")
			if var_list[7] == 1 and var_list[13] == 1 and var_list[14] == 1: run_gi(neg_3_text,"_neg_3")
			if var_list[8] == 1 and var_list[13] == 1 and var_list[14] == 1: run_lasswell(neg_3_text,"_neg_3")

			#### Nouns Only ####			
			if var_list[1] == 1 and var_list[9] == 1: run_galc(noun_text,"_nouns")
			if var_list[2] == 1 and var_list[9] == 1: run_nrc(noun_text,"_nouns")
			if var_list[3] == 1 and var_list[9] == 1: run_anew(noun_text,"_nouns")
			if var_list[4] == 1 and var_list[9] == 1: run_sentic(noun_text,"_nouns")
			if var_list[5] == 1 and var_list[9] == 1: run_vader(noun_text,"_nouns")
			if var_list[6] == 1 and var_list[9] == 1: run_lu_hui(noun_text,"_nouns")
			if var_list[7] == 1 and var_list[9] == 1: run_gi(noun_text,"_nouns")
			if var_list[8] == 1 and var_list[9] == 1: run_lasswell(noun_text,"_nouns")
			
			#### Verbs Only ####
			if var_list[1] == 1 and var_list[10] == 1: run_galc(verb_text,"_verbs")
			if var_list[2] == 1 and var_list[10] == 1: run_nrc(verb_text,"_verbs")
			if var_list[3] == 1 and var_list[10] == 1: run_anew(verb_text,"_verbs")
			if var_list[4] == 1 and var_list[10] == 1: run_sentic(verb_text,"_verbs")
			if var_list[5] == 1 and var_list[10] == 1: run_vader(verb_text,"_verbs")
			if var_list[6] == 1 and var_list[10] == 1: run_lu_hui(verb_text,"_verbs")
			if var_list[7] == 1 and var_list[10] == 1: run_gi(verb_text,"_verbs")
			if var_list[8] == 1 and var_list[10] == 1: run_lasswell(verb_text,"_verbs")
						
			#### Adjectives Only ####
			if var_list[1] == 1 and var_list[11] == 1: run_galc(adjective_text,"_adjectives")
			if var_list[2] == 1 and var_list[11] == 1: run_nrc(adjective_text,"_adjectives")
			if var_list[3] == 1 and var_list[11] == 1: run_anew(adjective_text,"_adjectives")
			if var_list[4] == 1 and var_list[11] == 1: run_sentic(adjective_text,"_adjectives")
			if var_list[5] == 1 and var_list[11] == 1: run_vader(adjective_text,"_adjectives")
			if var_list[6] == 1 and var_list[11] == 1: run_lu_hui(adjective_text,"_adjectives")
			if var_list[7] == 1 and var_list[11] == 1: run_gi(adjective_text,"_adjectives")
			if var_list[8] == 1 and var_list[11] == 1: run_lasswell(adjective_text,"_adjectives")
						
			#### Adverbs Only ####
			if var_list[1] == 1 and var_list[12] == 1: run_galc(adverb_text,"_adverbs")
			if var_list[2] == 1 and var_list[12] == 1: run_nrc(adverb_text,"_adverbs")
			if var_list[3] == 1 and var_list[12] == 1: run_anew(adverb_text,"_adverbs")
			if var_list[4] == 1 and var_list[12] == 1: run_sentic(adverb_text,"_adverbs")
			if var_list[5] == 1 and var_list[12] == 1: run_vader(adverb_text,"_adverbs")
			if var_list[6] == 1 and var_list[12] == 1: run_lu_hui(adverb_text,"_adverbs")
			if var_list[7] == 1 and var_list[12] == 1: run_gi(adverb_text,"_adverbs")
			if var_list[8] == 1 and var_list[12] == 1: run_lasswell(adverb_text,"_adverbs")

			#### Nouns Only Negation Checked ####			
			if var_list[1] == 1 and var_list[9] == 1and var_list[14] == 1: run_galc(noun_text_neg_3,"_nouns_neg_3")
			if var_list[2] == 1 and var_list[9] == 1and var_list[14] == 1: run_nrc(noun_text_neg_3,"_nouns_neg_3")
			if var_list[3] == 1 and var_list[9] == 1and var_list[14] == 1: run_anew(noun_text_neg_3,"_nouns_neg_3")
			if var_list[4] == 1 and var_list[9] == 1and var_list[14] == 1: run_sentic(noun_text_neg_3,"_nouns_neg_3")
			#if var_list[5].get() == 1 and var_list[9].get() == 1and var_list[14].get() == 1: run_vader(noun_text_neg_3,"_nouns_neg_3")
			if var_list[6] == 1 and var_list[9] == 1and var_list[14] == 1: run_lu_hui(noun_text_neg_3,"_nouns_neg_3")
			if var_list[7] == 1 and var_list[9] == 1and var_list[14] == 1: run_gi(noun_text_neg_3,"_nouns_neg_3")
			if var_list[8] == 1 and var_list[9] == 1and var_list[14] == 1: run_lasswell(noun_text_neg_3,"_nouns_neg_3")
			
			#### Verbs Only Negation Checked ####
			if var_list[1] == 1 and var_list[10] == 1and var_list[14] == 1: run_galc(verb_text_neg_3,"_verbs_neg_3")
			if var_list[2] == 1 and var_list[10] == 1and var_list[14] == 1: run_nrc(verb_text_neg_3,"_verbs_neg_3")
			if var_list[3] == 1 and var_list[10] == 1and var_list[14] == 1: run_anew(verb_text_neg_3,"_verbs_neg_3")
			if var_list[4] == 1 and var_list[10] == 1and var_list[14] == 1: run_sentic(verb_text_neg_3,"_verbs_neg_3")
			#if var_list[5].get() == 1 and var_list[10].get() == 1and var_list[14].get() == 1: run_vader(verb_text_neg_3,"_verbs_neg_3")
			if var_list[6] == 1 and var_list[10] == 1and var_list[14] == 1: run_lu_hui(verb_text_neg_3,"_verbs_neg_3")
			if var_list[7] == 1 and var_list[10] == 1and var_list[14] == 1: run_gi(verb_text_neg_3,"_verbs_neg_3")
			if var_list[8] == 1 and var_list[10] == 1and var_list[14] == 1: run_lasswell(verb_text_neg_3,"_verbs_neg_3")
						
			#### Adjectives Only Negation Checked ####
			if var_list[1] == 1 and var_list[11] == 1and var_list[14] == 1: run_galc(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[2] == 1 and var_list[11] == 1and var_list[14] == 1: run_nrc(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[3] == 1 and var_list[11] == 1and var_list[14] == 1: run_anew(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[4] == 1 and var_list[11] == 1and var_list[14] == 1: run_sentic(adjective_text_neg_3,"_adjectives_neg_3")
			#if var_list[5].get() == 1 and var_list[11].get() == 1and var_list[14].get() == 1: run_vader(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[6] == 1 and var_list[11] == 1and var_list[14] == 1: run_lu_hui(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[7] == 1 and var_list[11] == 1and var_list[14] == 1: run_gi(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[8] == 1 and var_list[11] == 1and var_list[14] == 1: run_lasswell(adjective_text_neg_3,"_adjectives_neg_3")
						
			#### Adverbs Only Negation Checked ####
			if var_list[1] == 1 and var_list[12] == 1and var_list[14] == 1: run_galc(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[2] == 1 and var_list[12] == 1and var_list[14] == 1: run_nrc(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[3] == 1 and var_list[12] == 1and var_list[14] == 1: run_anew(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[4] == 1 and var_list[12] == 1and var_list[14] == 1: run_sentic(adverb_text_neg_3,"_adverbs_neg_3")
			#if var_list[5].get() == 1 and var_list[12].get() == 1and var_list[14].get() == 1: run_vader(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[6] == 1 and var_list[12] == 1and var_list[14] == 1: run_lu_hui(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[7] == 1 and var_list[12] == 1and var_list[14] == 1: run_gi(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[8] == 1 and var_list[12] == 1and var_list[14] == 1: run_lasswell(adverb_text_neg_3,"_adverbs_neg_3")
						
			#Second Iteration of Components
			if var_list[15] == 1: component_count(components_2["C1.txt"],"negative_adjectives_component")
			if var_list[15] == 1: component_count(components_2["C2.txt"],"social_order_component")
			if var_list[15] == 1: component_count(components_2["C3.txt"],"action_component")
			if var_list[15] == 1: component_count(components_2["C4.txt"],"positive_adjectives_component")
			if var_list[15] == 1: component_count(components_2["C5.txt"],"joy_component")
			if var_list[15] == 1: component_count(components_2["C6.txt"],"affect_friends_and_family_component")
			if var_list[15] == 1: component_count(components_2["C7.txt"],"fear_and_digust_component")
			if var_list[15] == 1: component_count(components_2["C8.txt"],"politeness_component")
			if var_list[15] == 1: component_count(components_2["C9.txt"],"polarity_nouns_component")
			if var_list[15] == 1: component_count(components_2["C10.txt"],"polarity_verbs_component")
			if var_list[15] == 1: component_count(components_2["C11.txt"],"virtue_adverbs_component")
			if var_list[15] == 1: component_count(components_2["C12.txt"],"positive_nouns_component")
			if var_list[15] == 1: component_count(components_2["C13.txt"],"respect_component")
			if var_list[15] == 1: component_count(components_2["C14.txt"],"trust_verbs_component")
			if var_list[15] == 1: component_count(components_2["C15.txt"],"failure_component")
			if var_list[15] == 1: component_count(components_2["C16.txt"],"well_being_component")
			if var_list[15] == 1: component_count(components_2["C17.txt"],"economy_component")
			if var_list[15] == 1: component_count(components_2["C18.txt"],"certainty_component")
			if var_list[15] == 1: component_count(components_2["C19.txt"],"positive_verbs_component")
			if var_list[15] == 1: component_count(components_2["C20.txt"],"objects_component")

			if indice == 0: df_lexicons = pd.DataFrame(columns=header_list)
			df_lexicons.loc[indice] = [int(indice), int(nwords)] + variable_list
